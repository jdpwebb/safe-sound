...
// AES-MS-MT3620 ADC CHANNEL 1: Channel 1 using SOCKET1 AN. In the app manifest, it is only necessary to request the capability for the ADC Group Controller, AVNET_AESMS_ADC_CONTROLLER0.
#define AVNET_AESMS_ADC_CHANNEL1 MT3620_ADC_CHANNEL1

...
public:
    MfccWrapper()
    {
        _mfcc_Filter_output.resize(GetOutputSize(0));
    ...
    {
        mfcc_Filter(this, input.data(), _mfcc_Filter_output.data());
        return _mfcc_Filter_output;
    }


private:
    std::vector<float> _mfcc_Filter_output;
